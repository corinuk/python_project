...
def Towers():
    five_card_flush = Objects("./towers/five_card_flush.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    five_card = Objects("./towers/five_card.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    four_card = Objects("./towers/four_card.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    royal_straight_flush = Objects("./towers/royal_straight_flush.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    back_straight_flush = Objects("./towers/back_straight_flush.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    straight_flush = Objects("./towers/straight_flush.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    flush = Objects("./towers/flush.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    mountain = Objects("./towers/mountain.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    back_straight = Objects("./towers/back_straight.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    straight = Objects("./towers/straight.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    full_house = Objects("./towers/full_house.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    triple = Objects("./towers/triple.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    two_pair = Objects("./towers/two_pair.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    one_pair = Objects("./towers/one_pair.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    top = Objects("./towers/top.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
    tower1 = Objects("./towers/test.png", SCREEN_WIDTH//26, SCREEN_WIDTH//26)
