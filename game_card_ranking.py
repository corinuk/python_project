def card_ranking(poker_card):
    ...
    elif sorted_poker_card[0][1] == sorted_poker_card[1][1] == sorted_poker_card[2][1] == sorted_poker_card[3][1] or sorted_poker_card[1][1] == sorted_poker_card[2][1] == sorted_poker_card[3][1] == poker_card[4][1]:
        Ranking = 2
